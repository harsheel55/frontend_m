        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {categories.map((cat, index) => (
              ...
              >
                <div className="w-full h-48 md:h-52 mb-4 overflow-hidden rounded-lg bg-[#f5f6f2]">
                  <img
                    src={cat.image}
                    alt={cat.title}
                    className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300 border border-gray-300 rounded-md"
                  />
                </div>
